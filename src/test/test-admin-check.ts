/**
 * Admin-check detector accuracy harness.
 *
 * Mirrors the Phase 3-5b test structure.
 * Run via: npm run test:admin-check (~ $0.032 per run — 10 positives +
 * ~6 negatives reach the LLM; 4 negatives short-circuit pre-LLM).
 */
