 ...
 * detector id, the 17-fixture manifest, the EXPECTED_FLAGGED map, the two
 * MEDIUM-ceiling notes, and the positive/negative layout - is carried over
 ...
 * them. Documented so it never reads as a mislabel later. (Verbatim from 2a.)
 */
